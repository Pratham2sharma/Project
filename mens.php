...
<body>
    ...
    <header id="header">
      ...
      <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #e40046;">
        <div class="container-fluid">
          <a class="navbar-brand" href="index">Footwear Shoppee</a>
  ...
  <!-- End Header -->
  <main>
    <h1 class="title text-center p-1 m-1">MENS</h1>
    ...
    <section id="mens-section">
      <div class="container py-5">
      <h4 class="font-rubik font-size-20">Mens Collection</h4>
          <hr>
      <div class="column-1">
      ...
      <div class="column-1">
        <div class="product font-rale division">
          <a href="#"><img src="products/mens7.jpg" alt="product" class="img-fluid" style="height:200px; width:200px;"></a>
          <div class="text-center">
            <h6>Mens Shoes</h6>
            <div class="rating text-warning font-size-12">
              <span><i class="fas fa-star"></i></span>
        ...
        <div class="product font-rale division">
          <a href="#"><img src="products/mens8.jpg" alt="product" class="img-fluid" style="height:200px; width:200px;"></a>
          <div class="text-center">
            <h6>Mens Shoes</h6>
            <div class="rating text-warning font-size-12">
              <span><i class="fas fa-star"></i></span>
        ...
        <div class="product font-rale division">
          <a href="#"><img src="products/mens9.jpg" alt="product" class="img-fluid" style="height:200px; width:200px;"></a>
          <div class="text-center">
            <h6>Mens Shoes</h6>
            <div class="rating text-warning font-size-12">
              <span><i class="fas fa-star"></i></span>
      ...
      <div class="column-1">
        <div class="product font-rale division">
          <a href="#"><img src="products/mens10.jpg" alt="product" class="img-fluid" style="height:200px; width:200px;"></a>
          <div class="text-center">
            <h6>Mens Shoes</h6>
            <div class="rating text-warning font-size-12">
              <span><i class="fas fa-star"></i></span>
        ...
        <div class="product font-rale division">
          <a href="#"><img src="products/mens12.jpg" alt="product" class="img-fluid" style="height:200px; width:200px;"></a>
          <div class="text-center">
            <h6>Mens Shoes</h6>
            <div class="rating text-warning font-size-12">
              <span><i class="fas fa-star"></i></span>
